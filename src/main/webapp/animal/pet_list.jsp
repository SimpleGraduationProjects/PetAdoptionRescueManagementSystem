...
<div class="services" id="services">
    ...
    <%--<div class="w3l-img-side">
        <img src="/images/home/detail02.jpg" alt="" />
    </div>--%>
</div>
<div class="row">
    <!-- 分页条信息 -->
...
<script type="text/javascript">
    ...
    function build_pets_table(result){
        ...
        $.each(pets,function(index,pet){
            ...
            var imgTd=$("<div></div>").addClass("img").append($("<img/>").addClass("img-responsive").attr("src",pet.pic).attr("pet-id",pet.id));
            divTd.append(headTd);
            divTd.append(imgTd);
    ...
    $(document).on("click",".img-responsive",function(){
        ...
        $.ajax({
            ...
            type:"GET",
            success:function (result) {
                window.location.href="pet_detail.jsp";
            },
